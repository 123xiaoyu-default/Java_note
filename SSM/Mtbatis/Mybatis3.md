...
2. 项目搭建和准备
   ...
   1. 项目搭建
      ...
      ![img](assets/image-1740992833958-19.png)
...
3. 准备Mapper接口和MapperXML文件
   ...
   ![img](assets/image-1740992920734-22.png)
...
6. SqlSession和HttpSession区别
   ...
   ![](https://secure2.wostatic.cn/static/xb7Pyrm8YMF3qK6c7Jr5R3/image.png?auth_key=1740991353-fAbhuo6V2YtMnEELYsWe7s-0-bd78cf2b63a8db8a5af0e48f9480a624)
...
![image-20250303171635624](assets/image-20250303171635624.png)
...
![](assets/image-1740993405417-25.png)

### ${} 形式

${}形式传参，底层Mybatis做的是字符串拼接操作。

![](assets/image-1740993417857-28.png)
...
![img](assets/quality,Q_100&file_size=28218.webp)
...
![](assets/image-1740994060604-35.png)
...
![](assets/img006-1740994060604-36.png)
...
![](assets/image-1740994749197-45.png)
...
- Mapper 配置文件放在 Mapper 接口所在的包内
    ...
    - **可以在sources下创建mapper接口包一致的文件夹结构存放mapperxml文件**
        ...
        ![](assets/image-1740994826699-48.png)

        ![](assets/image-1740994826700-49.png)
...
2. 使用 IntelliJ IDEA连接数据库
    - 连接数据库
        ...
        ![](assets/image-1740994964110-54.png)
    - 填写信息

        ![](assets/image-1740994964110-55.png)
    - 展示库表

        ![](assets/image-1740994964111-56.png)
    - 逆向工程使用

        ![](assets/image-1740994964111-57.png)

        ![](assets/image-1740994964111-58.png)

        ![](assets/image-1740994964111-59.png)
3. 查看生成结果

    ![](assets/image-1740994964111-60.png)
4. 逆向工程案例使用
